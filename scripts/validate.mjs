...
const checks = [
  ...
  ['HTML defines real map layers', html.includes('data-map-tiles') && html.includes('data-map-marker-layer') && html.includes('data-location-action')],
  ['JavaScript renders real map tiles', js.includes('tile.openstreetmap.org') && js.includes('renderMapTiles') && js.includes('projectCoordinates')],
  ...
  ['CSS styles map tile and marker layers', css.includes('.map-tile') && css.includes('.map-marker-layer') && css.includes('.map-attribution') && css.includes('.map-cluster')],
