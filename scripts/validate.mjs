...
const checks = [
  ...
  ['HTML uses touch icon for brand mark', html.includes('class="brand-mark"') && html.includes('src="./apple-touch-icon.png"')],
  ...
  ['Service worker caches static app shell', serviceWorker.includes('APP_SHELL') && serviceWorker.includes('manifest.webmanifest') && serviceWorker.includes('apple-touch-icon.png') && serviceWorker.includes('src/map-services.js') && serviceWorker.includes('data/seed-cafes.csv')],
