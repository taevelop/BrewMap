...
const checks = [
  ...
  ['Admin HTML uses 운영자-facing labels', ['제보 검토', '운영 콘솔', '카페 관리', '태그 관리', 'CSV 가져오기', '변경 기록'].every((label) => adminHtml.includes(label)) && !['Admin Queue', 'Admin MVP', 'Cafe CRUD', 'Cafe List', 'Tag Management', 'CSV Import', 'Audit Log', 'MVP 필터'].some((label) => adminHtml.includes(label))],
